      ...
      <body className="leading-normal tracking-normal mx-auto w-full gradient bg-white dark:bg-gray-900">
        ...
        >
          <div className="container px-3 py-40 mx-auto flex flex-wrap flex-col md:flex-row items-center relative">
            <div className="absolute top-20 left-[20%] md:left-[30%] md:w-72 md:h-72 w-40 h-40 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl md:blur-2xl opacity-60 animate-blob1 dark:hidden"></div>
            <div className="absolute top-40 left-[30%] md:left-[40%] md:w-72 md:h-72 w-40 h-40 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl md:blur-2xl opacity-60 animate-blob2 dark:hidden "></div>
            <div className="absolute top-20 left-[40%] md:left-[50%] md:w-72 md:h-72 w-40 h-40 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl md:blur-2xl opacity-60 animate-blob3 dark:hidden "></div>
