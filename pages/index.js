      ...
      <body className="leading-normal tracking-normal mx-auto w-full gradient bg-white dark:bg-gray-900">
        <section id="hero">
          <div className="container px-3 py-40 mx-auto flex flex-wrap flex-col md:flex-row items-center relative">
            ...
            <div className="absolute top-20 left-[50%] md:w-72 md:h-72 w-40 h-40 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-blob dark:hidden animation-delay-1000"></div>
